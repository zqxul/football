                                        ...
                                        <#list waitingRecharges>
                                            ...
                                            <div class="col-9 py-2 px-0">
                                                <div class="row m-0 h-100 text-center" style="font-size: 1.3vw">
                                                    <div class="col">
                                                        ...
                                                        <div class="row h-50">
                                                            <div class="col"><i class="fa fa-user">&nbsp;</i>用户：<span style="font-size: 1.2vw">${recharge.createBy}</span></div>
                                                        </div>
                                                        <div class="row h-50">
                                                    ...
                                                    <div class="col">
                                                        <div class="row h-10"></div>
                                                        <div class="row h-45">
                                                            <div class="col"><i class="fa fa-cny text-danger">&nbsp;</i>充值金额：<span>${recharge.amount}</span></div>
                                                        </div>
                                                        <div class="row h-45">
                                                            <div class="col"><i class="fa fa-stop-circle-o text-warning">&nbsp;</i>球币数量：<span>${recharge.amount*10}</span></div>
                                                        </div>
                                                    </div>
                                                    <div class="col-5 px-4 text-center">
                                                        ...
                                                        <div class="row h-30 m-0" style="font-size: 1vw">
                                                            <div class="col p-0">创建时间:&nbsp;<span>${recharge.createTime?string("yyyy-MM-dd HH:ss:mm")}</span></div>
                                                        </div>
                                                    </div>
                                                </div>
                                            </div>
                                            <div class="col-3">
                                                <div class="row m-0 px-2 text-center"
                                                    ...
                                                    <div class="col p-1"><a class="btn btn-light" userId="${recharge.userId}" amount="${recharge.amount}" rechargeId="${recharge.id}">确认充值</a></div>
                                                    <div class="col p-1"><a class="btn btn-light" userId="${recharge.userId}" amount="${recharge.amount}" rechargeId="${recharge.id}">作废</a></div>
                                                </div>
                                            </div>
                                        </div>
                                            </#items>
                                        ...
                                        <div class="row m-0 my-2" style="height: 100px;border: 1px solid #e0e0e0;">
                                            <div class="col-9 py-2 px-0">
                                                <div class="row m-0 h-100 text-center" style="font-size: 1.3vw">
                                                    ...
                                                    <div class="col-5 px-4 text-center">
                                                        <div class="row h-70 m-0 pt-2">
                                                            <div class="col p-0"></div>
                                                            <div class="col p-2" style="font-size: 1.2vw">
                                                                <!--<span class="p-2 text-success">充值成功</span>-->
                                                                <span class="p-2 text-danger">充值失败</span>
                                            ...
                                            <div class="col-3">
                                                <div class="row m-0 px-2 text-center"
                                                     style="height: 100px;line-height: 85px">
                                                    <div class="col p-1"><a class="btn btn-light">撤消</a></div>
                                    ...
                                    <div class="card-body p-0 px-2">
                                        ...
                                        <div class="row m-0 my-2" style="height: 100px;border: 1px solid #e0e0e0;">
                                            ...
                                            <div class="col-2">
                                                <div class="row m-0 px-2 text-center"
                                                     style="height: 100px;line-height: 85px">
                                                    <div class="col p-1"><a class="btn btn-light">清除</a></div>
                                                    <!--<div class="col p-1"><a class="btn btn-light">作废</a></div>-->
                                                </div>
                                            </div>
                                        </div>
