...
function recharge() {
    $.ajax({
        ...
        method: 'get',
        data: 'rechargeAmount=' + $('#rechargeAmount').val(),
        success: function (data) {
            ...
            if (code == 3015) {
                ...
                $('#accountMsg').html('<span>' + msg + '&nbsp;<i class="fa fa-check"></i></span>');
                $('#accountTip').fadeIn(1000);
                $('#accountTip').fadeOut(5000);
            } else {
                $('#rechargeModal').modal('hide');
                $('#accountMsg').html('<span class="text-danger">' + msg + '&nbsp;<i class="fa fa-close"></i></span>');
                $('#accountTip').fadeIn(1000);
                $('#accountTip').fadeOut(5000);
            }
        }
